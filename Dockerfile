...
ARG GO_ENV_PACKAGE_NAME=github.com/sinlov/drone-env-printer
ARG GO_ENV_ROOT_BUILD_BIN_NAME=drone-env-printer
ARG GO_ENV_ROOT_BUILD_BIN_PATH=build/${GO_ENV_ROOT_BUILD_BIN_NAME}
ARG GO_ENV_ROOT_BUILD_ENTRANCE=cmd/drone-env-printer/main.go
