...
func action(c *cli.Context) error {
	...
	p := env_printer_plugin.BindCliFlag(c, cliVersion, Name, drone)
	err := p.Exec()
...
func main() {
	...
	app.Action = action
	flags := drone_urfave_cli_v2.UrfaveCliAppendCliFlag(drone_urfave_cli_v2.DroneInfoUrfaveCliFlag(), env_printer_plugin.CommonFlag())
	flags = drone_urfave_cli_v2.UrfaveCliAppendCliFlag(flags, env_printer_plugin.Flag())
	flags = drone_urfave_cli_v2.UrfaveCliAppendCliFlag(flags, env_printer_plugin.HideFlag())
	app.Flags = flags
